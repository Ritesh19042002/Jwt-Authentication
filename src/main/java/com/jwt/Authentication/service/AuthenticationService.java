...
import com.jwt.Authentication.dto.RegisterUserDto;
import com.jwt.Authentication.dto.VerifyUserDto;
...
public class AuthenticationService {
    ...
    public void verifyUser(VerifyUserDto input) {
        ...
        if (optionalUser.isPresent()) {
            ...
            if (LocalDateTime.parse(user.getVerificationCodeExpiresAt()).isBefore(LocalDateTime.now())) {
